from pulpcore.plugin.serializers import RepositorySyncURLSerializer
...
# Custom checks for namespaces within distributions


def has_add_namespace_perms(request, view, action):
    """
    ...
    try:
        namespace = ContainerNamespace.objects.get(name=namespace)
...
def has_view_namespace_perms(request, view, action):
    """
